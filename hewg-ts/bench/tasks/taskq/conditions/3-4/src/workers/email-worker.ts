/**
 * @hewg-module taskq/workers/email-worker
 *
...
/** Payload shape expected by the email worker. */
...
/** An email worker extends BaseWorker with SMTP-specific processing. */
export interface EmailWorker extends BaseWorker {
  readonly workerKind: "email";
}
