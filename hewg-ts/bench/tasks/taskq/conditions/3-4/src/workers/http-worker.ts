/**
 * @hewg-module taskq/workers/http-worker
 *
...
/** Payload shape expected by the HTTP worker. */
...
/** An HTTP worker extends BaseWorker with HTTP-specific processing. */
export interface HttpWorker extends BaseWorker {
  readonly workerKind: "http";
}
