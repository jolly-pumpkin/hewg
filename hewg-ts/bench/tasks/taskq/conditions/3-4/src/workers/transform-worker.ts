/**
 * @hewg-module taskq/workers/transform-worker
 *
...
/** Payload shape expected by the transform worker. */
...
/** A transform worker extends BaseWorker for pure computation. */
export interface TransformWorker extends BaseWorker {
  readonly workerKind: "transform";
}

/**
 * Create a transform worker that runs pure data transformations.
 * @hewg-module taskq/workers/transform-worker
 * @effects log, time.read
 */
