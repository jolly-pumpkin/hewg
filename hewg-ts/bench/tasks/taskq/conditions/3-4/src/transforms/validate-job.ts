/**
 * @hewg-module taskq/transforms/validate-job
 *
 * Validation logic for job creation inputs and payloads.
 */
...
/**
 * Validate a CreateJobInput, checking all fields for correctness.
 * Payload size is validated against the provided plan limit.
 * @hewg-module taskq/transforms/validate-job
 * @effects
 */
...
/**
 * Check whether a payload, when serialized, fits within the byte limit.
 * @hewg-module taskq/transforms/validate-job
 * @effects
 */
